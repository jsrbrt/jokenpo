...
public class JoKenPo {
    ...
    public void toPlay() throws NumberFormatException{
    ...
    //JPanel scoreOutputPanel = new JPanel();
    ...
    public void showScore() {
        /*scoreDialog.setTitle(user.getName() + " X " + AI.getName());

        String output = user.getScore() + " X " + AI.getScore();
        JLabel outputLabel = new JLabel(output);
        scoreOutputPanel.add(outputLabel);
        scoreOutputPanel.setLayout(new BoxLayout(scoreOutputPanel, BoxLayout.Y_AXIS));

        scoreDialog.add(scoreOutputPanel);
        scoreDialog.pack();
